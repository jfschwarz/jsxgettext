...
var opts = require("nomnom")
   ...
   .option('keyword', {
      abbr: 'k',
      metavar: 'WORD',
      help: 'additional keyword to be looked for as gettext alias'
   })
   .option('plural', {
      abbr: 'n',
      metavar: 'WORD',
      help: 'additional keyword to be looked for as ngettext alias'
   })
   ...
   .option('language', {
      ...
      metavar: 'NAME',
      default: 'JavaScript',
      help: 'recognise the specified language (JavaScript, Babel, EJS, Jinja, Jade, Handlebars)'
   })
   .parse();
...
function gen (sources) {
  ...
  } else if (opts.language.toUpperCase() === 'BABEL') {
    result = jsxgettext.generateFromBabel(sources, opts);
  } else {
